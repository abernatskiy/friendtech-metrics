module.exports = class Data1693771301483 {
    name = 'Data1693771301483'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "subject" ("id" character varying NOT NULL, "address" text NOT NULL, "first_trade_block" integer NOT NULL, "supply" numeric NOT NULL, "total_trades" integer NOT NULL, "total_eth_volume" numeric NOT NULL, "total_eth_buy_volume" numeric NOT NULL, "total_eth_sell_volume" numeric NOT NULL, "total_share_volume" numeric NOT NULL, "total_share_buy_volume" numeric NOT NULL, "total_share_sell_volume" numeric NOT NULL, "subject_eth_total" numeric NOT NULL, "own_share_volume" numeric NOT NULL, "own_share_bought" numeric NOT NULL, "own_share_sold" numeric NOT NULL, "eth_paid_for_own_share" numeric NOT NULL, "eth_received_for_own_share" numeric NOT NULL, "own_share_trading_profit" numeric NOT NULL, "ultimate_subject_profit" numeric NOT NULL, CONSTRAINT "PK_12eee115462e38d62e5455fc054" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "all_time_stats" ("id" character varying NOT NULL, "trades" integer NOT NULL, "num_subjects" integer NOT NULL, "eth_volume" numeric NOT NULL, "eth_buy_volume" numeric NOT NULL, "eth_sell_volume" numeric NOT NULL, "share_volume" numeric NOT NULL, "share_buy_volume" numeric NOT NULL, "share_sell_volume" numeric NOT NULL, "subject_eth_total" numeric NOT NULL, "protocol_eth_total" numeric NOT NULL, CONSTRAINT "PK_2a520dc16e32136eccc03d3ceee" PRIMARY KEY ("id"))`)
    }
    ...
    async down(db) {
        ...
        await db.query(`DROP TABLE "all_time_stats"`)
    }
}
